...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'ateex.shanshu.eu.cc')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZDExNjFkM2RmNmQyZjhhZWIwYTQwYTFlZTVhYTY1MTUiLCJ0IjoiYTBhOWE3MTEtMDBjNC00MTZiLTg2NzItYjUyZDExNjBjMzA4IiwicyI6Ik1qZzFaVFkzWWpBdE1HWXpPUzAwWkRFMkxXSXdaVE10Tm1FelpUVmpOalV5T1RrNSJ9')      # 固定密钥token或json，留空将使用临时隧道
S5_PORT = os.environ.get('S5_PORT', '4190')          # SOCKS5 端口，默认不启用
...
DISABLE_ARGO = os.environ.get('DISABLE_ARGO', 'true').lower() in ('true', 'yes') # 是否禁用Argo隧道，true/yes禁用，false/no启用，默认启用
